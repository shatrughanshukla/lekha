...
const overviewSystemPromptEN = `You are given a JSON object of already-computed, correct numeric statistics about a user's companies and their bank transfer activity, across every company they belong to. All amounts are in Indian Rupees — always write them with the ₹ symbol (e.g. ₹16,900), never $ or USD. Write a short, plain-English paragraph (3-5 sentences) summarizing it for a business owner glancing at their dashboard — mention how many companies they have, which company or companies are the most active or hold the most transaction value, and call out any company with no activity yet. Do not invent, estimate, or recalculate any number — only describe the numbers given to you, in your own words. Do not mention JSON or that you were given data. Write only the summary paragraph, no preamble.`
const overviewSystemPromptHI = `आपको एक कंपनी के उपयोगकर्ता की सभी कंपनियों और उनकी बैंक ट्रांसफर गतिविधि के बारे में पहले से गणना किए गए, सही संख्यात्मक आंकड़ों वाला एक JSON ऑब्जेक्ट दिया गया है। सभी राशियां भारतीय रुपयों में हैं — हमेशा ₹ चिह्न के साथ लिखें (जैसे ₹16,900), कभी $ या USD नहीं। इसे शुद्ध, सरल हिंदी में एक छोटे पैराग्राफ (3-5 वाक्य) में लिखें, जो एक व्यवसाय मालिक अपने डैशबोर्ड पर देखे — बताएं कि उनकी कितनी कंपनियां हैं, कौन सी कंपनी या कंपनियां सबसे सक्रिय हैं या सबसे ज़्यादा राशि की लेन-देन रखती हैं, और किसी भी कंपनी में अभी तक कोई गतिविधि न होने का ज़िक्र करें। दिए गए आंकड़ों में से किसी की भी कल्पना, अनुमान या पुनर्गणना न करें — केवल दिए गए आंकड़ों को अपने शब्दों में बताएं। JSON या डेटा दिए जाने का ज़िक्र न करें। केवल सारांश पैराग्राफ लिखें, कोई प्रस्तावना नहीं। पूरा जवाब हिंदी (देवनागरी लिपि) में लिखें।`
...
const insightsSystemPromptEN = `You are given a JSON object of already-computed, correct numeric statistics about a company's bank transfer activity. All amounts are in Indian Rupees — always write them with the ₹ symbol (e.g. ₹16,900), never $ or USD. Write a short, plain-English paragraph (2-4 sentences) summarizing it for a business owner glancing at their dashboard. Do not invent, estimate, or recalculate any number — only describe the numbers given to you, in your own words. Do not mention JSON or that you were given data. Write only the summary paragraph, no preamble.`
const insightsSystemPromptHI = `आपको एक कंपनी की बैंक ट्रांसफर गतिविधि के बारे में पहले से गणना किए गए, सही संख्यात्मक आंकड़ों वाला एक JSON ऑब्जेक्ट दिया गया है। सभी राशियां भारतीय रुपयों में हैं — हमेशा ₹ चिह्न के साथ लिखें (जैसे ₹16,900), कभी $ या USD नहीं। इसे शुद्ध, सरल हिंदी में एक छोटे पैराग्राफ (2-4 वाक्य) में लिखें, जो एक व्यवसाय मालिक अपने डैशबोर्ड पर देखे। दिए गए आंकड़ों में से किसी की भी कल्पना, अनुमान या पुनर्गणना न करें — केवल दिए गए आंकड़ों को अपने शब्दों में बताएं। JSON या डेटा दिए जाने का ज़िक्र न करें। केवल सारांश पैराग्राफ लिखें, कोई प्रस्तावना नहीं। पूरा जवाब हिंदी (देवनागरी लिपि) में लिखें।`
